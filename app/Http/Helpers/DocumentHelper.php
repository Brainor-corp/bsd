...
class DocumentHelper
{
    ...
    public static function generateTransferDocument($documentData, $documentName)
    {
        ...
        $documentData['Услуги'] = array_map(function ($el) {
            ...
            $el['КодТовара'] = ' '; // todo 1c не возвращает
            $el['КодВидаТовара'] = ' '; // todo 1c не возвращает
            $el['КодЕдиницыИзмерения'] = ' '; // todo 1c не возвращает
            $el['УсловноеОбозначениеЕдиницыИзмерения'] = ' '; // todo 1c не возвращает
            $el['СуммаАкциза'] = ' '; // todo 1c не возвращает
            $el['ЦифровойКодСтраны'] = ' '; // todo 1c не возвращает
            $el['КраткоеНаименованиеСтраны'] = ' '; // todo 1c не возвращает
            $el['РегистрационныйНомер'] = ' '; // todo 1c не возвращает
