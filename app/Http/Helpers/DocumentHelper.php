...
class DocumentHelper
{
    ...
    public static function generateTransferDocument($documentData, $documentName)
    {
        ...
        $documentData['Услуги'] = array_map(function ($el) {
            ...
            $el['КодТовара'] = 'test';
            $el['КодВидаТовара'] = 'test';
            $el['КодЕдиницыИзмерения'] = 'test';
            $el['УсловноеОбозначениеЕдиницыИзмерения'] = 'test';
            $el['СуммаАкциза'] = 'test';
            $el['ЦифровойКодСтраны'] = 'test';
            $el['КраткоеНаименованиеСтраны'] = 'test';
            $el['РегистрационныйНомер'] = 'test';
