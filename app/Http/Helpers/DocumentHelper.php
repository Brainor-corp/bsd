...
class DocumentHelper
{
    ...
    public static function generateTransferDocument($documentData, $documentName)
    {
        ...
        $params['[КодТовара]'] = 'test';
        $params['[КодВидаТовара]'] = 'test';
        $params['[КодЕдиницыИзмерения]'] = 'test';
        $params['[УсловноеОбозначениеЕдиницыИзмерения]'] = 'test';
        $params['[СуммаАкциза]'] = 'test';
        $params['[ЦифровойКодСтраны]'] = 'test';
        $params['[КраткоеНаименованиеСтраны]'] = 'test';
        $params['[РегистрационныйНомер]'] = 'test';
