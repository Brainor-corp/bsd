...
<div>
    ...
    <span class="hl">Телефон (контактное лицо): <i><b><u></u></b></i></span><br>
    ...
    <span class="hl">Телефон получателя: <i><b><u></u></b></i></span><br>
    ...
    <span class="hl">Нужна ли доставка до адреса получателя: <i><b><u>{{ $documentData['АдресДоставки'] ? 'Да' : '-' }}</u></b></i></span><br>
