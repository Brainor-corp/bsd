...
<div class="form-item row align-items-center">
    ...
    <div class="col">
        <input type="text"
               ...
               value="{{ $order->recipient_company_name ?? '' }}"
...
<div class="form-item row align-items-center">
    ...
    <div class="col calc__inpgrp"><input type="text" maxlength="12" id="recipient_inn" name="recipient_inn" value="{{ $order->recipient_inn ?? '' }}" class="form-control req" {{ isset($disabled) ? 'disabled' : 'required' }}/></div>
</div>
<div class="form-item row align-items-center">
    <label class="col-auto calc__label" for="recipient_kpp">КПП*</label>
    <div class="col calc__inpgrp"><input type="text" maxlength="9" id="recipient_kpp" name="recipient_kpp" value="{{ $order->recipient_kpp ?? '' }}" class="form-control req" {{ isset($disabled) ? 'disabled' : 'required' }}/></div>
</div>
<div class="form-item row align-items-center">
...
<div class="form-item row align-items-center">
    ...
    <div class="col calc__inpgrp"><input type="text" placeholder="+7(XXX)XXX-XX-XX" class="form-control req phone-mask" id="recipient_phone_legal" name="recipient_phone_legal" value="{{ $order->recipient_phone ?? '' }}" {{ isset($disabled) ? 'disabled' : 'required' }}/></div>
</div>
<div class="form-item row align-items-center">
