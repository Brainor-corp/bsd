<div class="form-item row align-items-center">
    ...
    <div class="col calc__inpgrp"><input type="text" id="recipient_legal_form" value="{{ $order->recipient_legal_form ?? '' }}" name="recipient-legal-form" class="form-control req" placeholder="ИП, ООО, АО" {{ isset($disabled) ? 'disabled' : 'required' }} /></div>
</div>
<div class="form-item row align-items-center">
...
<div class="form-item row align-items-center">
    <label class="col-auto calc__label" for="recipient_name">Контактноя лицо*</label>
    <div class="col calc__inpgrp"><input type="text" id="recipient_name" class="form-control req" name="recipient_name" value="{{ $order->recipient_name ?? '' }}" {{ isset($disabled) ? 'disabled' : 'required' }}/></div>
</div>
<div class="form-item row align-items-center">
    <label class="col-auto calc__label" for="recipient_phone">Телефон*</label>
    <div class="col calc__inpgrp"><input type="text" class="form-control req" id="recipient_phone" name="recipient_phone" value="{{ $order->recipient_phone ?? '' }}" {{ isset($disabled) ? 'disabled' : 'required' }}/></div>
</div>
<div class="form-item row align-items-center">
