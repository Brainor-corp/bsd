...
<div class="form-item row align-items-center">
    ...
    <div class="col">
        ...
        <input type="text" name="payer_legal_address_street" value="{{ old('payer_legal_address_street') ?? ($order->payer_legal_address_street ?? '') }}" class="form-control form-item req"  placeholder="Улица" {{ isset($disabled) ? 'disabled' : 'required' }}/>
        <div class="input-group">
            <input type="text" name="payer_legal_address_house" value="{{ old('payer_legal_address_house') ?? ($order->payer_legal_address_house ?? '') }}" class="form-control text-center form-item" placeholder="Дом" {{ isset($disabled) ? 'disabled' : '' }}/>
            <input type="text" name="payer_legal_address_block" value="{{ old('payer_legal_address_block') ?? ($order->payer_legal_address_block ?? '') }}" class="form-control text-center form-item" placeholder="Корп." {{ isset($disabled) ? 'disabled' : '' }}/>
            <input type="text" name="payer_legal_address_building" value="{{ old('payer_legal_address_building') ?? ($order->payer_legal_address_building ?? '') }}" class="form-control text-center form-item" placeholder="Стр." {{ isset($disabled) ? 'disabled' : '' }}/>
            <input type="text" name="payer_legal_address_apartment" value="{{ old('payer_legal_address_apartment') ?? ($order->payer_legal_address_apartment ?? '') }}" class="form-control text-center" placeholder="Кв./оф." {{ isset($disabled) ? 'disabled' : '' }}/>
        </div>
    </div>
</div>
<div class="form-item row align-items-center">
