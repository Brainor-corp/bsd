            ...
            <div class="row justify-content-between align-items-start">
                ...
                <div class="col-lg-auto text-lg-left text-center py-4 py-lg-0 col-12">
                    <ul class="list-inline nav-icons-list mb-0">
                        <li class="list-inline-item mr-1 position-relative" data-toggle="tooltip" data-placement="bottom" title="Заявка"><a href="{{ route('calculator-show', ['id' => null, 'type' => 'order']) }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><style>.cls-1,.cls-2,.cls-3{fill:none;}.cls-2,.cls-3{stroke:#323232;stroke-linecap:round;stroke-linejoin:round;}.cls-2{stroke-width:1.48px;}.cls-3{stroke-width:1.5px;}</style></defs><title>Заявка</title><g id="Слой_2" data-name="Слой 2"><g id="Icons"><rect class="cls-1" width="24" height="24"/><path class="cls-2" d="M21,10.71V19a2,2,0,0,1-1.95,2H5A2,2,0,0,1,3,19V7A2,2,0,0,1,5,5H10.3"/><path class="cls-3" d="M18.06,3.5a1.73,1.73,0,0,1,2.44,0h0a1.73,1.73,0,0,1,0,2.44l-5.78,5.77A1,1,0,0,1,14,12H12V10a1,1,0,0,1,.29-.71Z"/><line class="cls-3" x1="8" y1="12" x2="6" y2="12"/><line class="cls-3" x1="6" y1="16" x2="18" y2="16"/><line class="cls-3" x1="19.43" y1="7" x2="17" y2="4.57"/></g></g></svg></a></li>
