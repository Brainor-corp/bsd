            ...
            <div class="d-flex flex-wrap flex-xl-row col-xl-12 justify-content-between">
                                ...
                                <ul class="nav navbar-nav d-flex nav_top m-0">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div role="menu" class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="#">Рекламодателям</a>
                                            <a class="dropdown-item" href="#">Адреса терминалов</a>
                                            <a class="dropdown-item" href="#">Документы и сертификаты</a>
                ...
                <div class="col-12 col-md-8 col-xl d-flex flex-column flex-sm-row header__top_right">
                    <ul class="col-sm-6 nav-icons-list d-flex flex-row justify-content-center justify-content-sm-end align-items-sm-center">
                        <li class="relative" data-toggle="tooltip" data-placement="bottom" title="Калькулятор"><a href="#"><svg viewBox="-35 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m427 0h-412c-8.285156 0-15 6.714844-15 15v482c0 8.285156 6.714844 15 15 15h412c8.285156 0 15-6.714844 15-15v-482c0-8.285156-6.714844-15-15-15zm-15 482h-382v-452h382zm0 0"/><path d="m75 218h292c8.285156 0 15-6.714844 15-15v-128c0-8.285156-6.714844-15-15-15h-292c-8.285156 0-15 6.714844-15 15v128c0 8.285156 6.714844 15 15 15zm15-128h262v98h-262zm0 0"/><path d="m367 240h-58c-8.285156 0-15 6.714844-15 15v183c0 8.285156 6.714844 15 15 15h58c8.285156 0 15-6.714844 15-15v-183c0-8.285156-6.714844-15-15-15zm-15 183h-28v-153h28zm0 0"/><path d="m75 452h60c8.285156 0 15-6.714844 15-15v-60c0-8.285156-6.714844-15-15-15h-60c-8.285156 0-15 6.714844-15 15v60c0 8.285156 6.714844 15 15 15zm15-60h30v30h-30zm0 0"/><path d="m255 362h-60c-8.285156 0-15 6.714844-15 15v60c0 8.285156 6.714844 15 15 15h60c8.285156 0 15-6.714844 15-15v-60c0-8.285156-6.714844-15-15-15zm-15 60h-30v-30h30zm0 0"/><path d="m75 332h60c8.285156 0 15-6.714844 15-15v-60c0-8.285156-6.714844-15-15-15h-60c-8.285156 0-15 6.714844-15 15v60c0 8.285156 6.714844 15 15 15zm15-60h30v30h-30zm0 0"/><path d="m255 242h-60c-8.285156 0-15 6.714844-15 15v60c0 8.285156 6.714844 15 15 15h60c8.285156 0 15-6.714844 15-15v-60c0-8.285156-6.714844-15-15-15zm-15 60h-30v-30h30zm0 0"/></svg></a></li>
