<p style="text-align: center;"><span style="font-size:24px;"><strong>Доставка грузов по маршруту {{ $route->real_arrow_name }}</strong></span></p>

<p>&nbsp;</p>

<p>
    <span style="font-size:16px;">
        <span style="color:#5a666e;">Балтийская Служба Доставки осуществляет грузоперевозки по маршруту {{ $route->real_arrow_name }}. </span>
